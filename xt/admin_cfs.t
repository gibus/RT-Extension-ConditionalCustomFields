...
use RT::Extension::ConditionalCustomFields::Test tests => 30;
...
is($cf_conditioned_by_CF_options[1]->get_value, $cf_conditioned_by_child->id, 'Can be conditioned by Condition Child (with js)');
