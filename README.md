...
Also `HTML` [custom fields](https://docs.bestpractical.com/rt/5.0.4/RT/CustomField.html) introduced in RT 5.0.3 works only on a statuc way when displaying or editing the Object, but not dynamically when changing the text in CKE Editor.
